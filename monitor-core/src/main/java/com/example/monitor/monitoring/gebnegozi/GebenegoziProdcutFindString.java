...
public class GebenegoziProdcutFindString {
    ...
    public static final String[][] GEBE_URL_LIST = {
            ...
            {"RED WING", "SHOES", "http://93.46.41.5:1995/list-items?lsc=&lse=47,60,61,58,59&lde=1673&is=-1&ir=-2&ci=1&m=&s=0&n=1&cust=&cg=0", "man"},
            ...
            {"PRADA", "CLOTHING", "http://93.46.41.5:1995/list-items?lsc=&lse=47,62,61,60,59,58&lde=675&is=-1&ir=6&ci=1&m=&s=0&n=1&cust=&cg=0", "woman"},
